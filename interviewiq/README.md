...
InterviewIQ is a simple tool that helps hiring managers come up with better interview questions. Instead of asking generic questions that candidates are ready for, it generates thoughtful, role-specific questions that actually reveal how someone thinks and approaches problems.

You type in a job title, and it gives you three interview questions tailored to that role. That's it.
...
- Simple web interface (just HTML, CSS, and JavaScript)
- Flask: for the backend
- Gemini AI:  to generate the questions
